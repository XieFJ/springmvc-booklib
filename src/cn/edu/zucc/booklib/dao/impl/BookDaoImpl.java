...
public class BookDaoImpl implements BookDAO {
	...
	@Override
	public void modifyBook(BeanBook book, String bookName, String author, String publisher, int stockNumber,BeanBookType bookType)  {
		Session session = getCurrentSession();
	...
	public List<BeanBook> findBooks(String bookName, String author, BeanBookType bookType)  {
	    ...
	    if(bookName!=null&&!("").equals(bookName)){
	        hql=hql+" and bookName='"+bookName+"'";
	    }
	    if(author!=null&&!("").equals(author)){
	        hql=hql+" and author='"+author+"'";
	    }
	    if(bookType!=null&&!("").equals(bookType)){
